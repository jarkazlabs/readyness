const STORAGE_KEY = "readyness-prototype-v14";
...
function unlockPageScroll(){
  if(!$("inputModal")?.classList.contains("open") && !$("decisionModal")?.classList.contains("open")){
